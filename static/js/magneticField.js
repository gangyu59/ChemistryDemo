function startMagneticField(canvas, ctx, clearCanvasAndStop) {
    ...
    function drawFieldLines() {
        ...
        updateIronFilings();
        // Store animation frame id so main.js can cancel it on demo switch.
        // This demo otherwise keeps running and overwrites the canvas.
        animationFrameId = requestAnimationFrame(drawFieldLines);
    }
